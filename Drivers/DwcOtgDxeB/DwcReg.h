...
#define HCCHAR(_ch)                      (0x0500 + 0x20 * (_ch))
#define HCSPLT(_ch)                      (0x0504 + 0x20 * (_ch))
#define HCINT(_ch)                       (0x0508 + 0x20 * (_ch))
#define HCINTMSK(_ch)                    (0x050c + 0x20 * (_ch))
#define HCTSIZ(_ch)                      (0x0510 + 0x20 * (_ch))
#define HCDMA(_ch)                       (0x0514 + 0x20 * (_ch))
#define HCDMAB(_ch)                      (0x051c + 0x20 * (_ch))
...
#define GAHBCFG                          (0x008)  // AHB config
#define GUSBCFG                          (0x00C)  // Core USB config
#define GRSTCTL                          (0x010)  // Core Reset
#define GINTSTS                          (0x014)  // Core Interrupt
#define GINTMSK                          (0x018)  // Core Interrupt Mask
#define GRXSTSR                          (0x01C)  // Receive Status Queue Read
#define GRXSTSP                          (0x020)  // Receive Status Queue Read and POP
...
#define GI2CCTL                          (0x0030) // I2C access
#define GPVNDCTL                         (0x0034) // PHY vendor control
#define GGPIO                            (0x0038) // GPIO
#define GUID                             (0x003c) // User ID
#define GSNPSID                          (0x0040) // Synopsis ID
#define GHWCFG1                          (0x0044) // User HW Config1
#define GHWCFG2                          (0x0048) // User HW Config2
#define GHWCFG3                          (0x004c) // User HW Config3
#define GHWCFG4                          (0x0050) // User HW Config4
#define GLPMCFG                          (0x0054) // Core LPM config
#define HPTXFSIZ                         (0x100)  // Host periodic TX FIFO Size
#define DPTXFSIZN(_a)                    (0x104 + (((_a) - 1) * 4))
#define HPRT0                            (0x0440)
...
#define DWC2_GAHBCFG_HBURSTLEN                          (0xf << 1)
...
#define DWC2_MAX_TRANSFER_SIZE			 524784
#define DWC2_MAX_PACKET_COUNT            1023
...
#define DWC2_STATUS_BUF_SIZE            511
#define DWC2_DATA_BUF_SIZE              (511 * 1024)
